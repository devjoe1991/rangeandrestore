    ...
    <>
      <div className="bg-[#c6e28a] py-12 lg:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl lg:text-5xl font-bold text-[#334311]">Terms and Conditions</h1>
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
          <section>
            <h2 className="text-2xl font-bold text-[#334311]">1. About These Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#334311]">2. Appointments and Booking</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#334311]">3. Cancellation and Late Arrival Policy</h2>
            <ul className="space-y-3 list-disc list-inside">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#334311]">4. Payment</h2>
            <ul className="space-y-3 list-disc list-inside">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#334311]">5. Bundle Packages</h2>
            <ul className="space-y-3 list-disc list-inside">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#334311]">6. Gift Cards</h2>
            <ul className="space-y-3 list-disc list-inside">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#334311]">7. Health and Safety</h2>
            <ul className="space-y-3 list-disc list-inside">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#334311]">8. Conduct</h2>
            <ul className="space-y-3 list-disc list-inside">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#334311]">9. Liability</h2>
            <ul className="space-y-3 list-disc list-inside">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#334311]">10. Governing Law</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#334311]">11. Changes to These Terms</h2>
            <p>
