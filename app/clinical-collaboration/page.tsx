        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <div className="space-y-4">
              {[
                {
                  title: 'Assessment-led referral',
                  desc: 'If Carlos identifies during a massage assessment that imaging may be useful to clarify a diagnosis or rule out more serious pathology — for example, in cases of suspected tendon tear or persistent unexplained pain — he can discuss a referral to Reliable Scan.',
                },
                {
                  title: 'Coordinated care',
                  desc: 'Having the imaging clinic and massage clinic in the same building means results can be shared efficiently, treatment can be adapted based on findings, and clients do not have to navigate multiple locations or long waiting lists.',
                },
                {
                  title: 'Informed treatment',
