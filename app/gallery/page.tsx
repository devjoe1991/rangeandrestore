...
export const metadata: Metadata = buildMetadata({
  title: 'Sports Massage Clinic Gallery – Archway, North London',
    ...
    <>
      ...
      <div className="bg-[#c6e28a] py-12 lg:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 text-xl text-[#334311]/80">Inside Range and Restore Sports Massage, Archway</p>
          <p className="mt-4 text-[#334311]/65 max-w-2xl">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        {/* ── CTA ──────────────────────────────────────────────── */}
        <div className="mt-12 pt-10 border-t border-[#c1e082] flex flex-col sm:flex-row gap-4 items-start">
          <BookingButton label="Book Your Session" />
          <Link
            href="/about"
            className="inline-flex items-center justify-center rounded-full border border-[#618020] text-[#618020] font-semibold px-6 py-3 hover:bg-[#618020] hover:text-white transition-colors min-h-[44px] text-sm"
          >
            Meet Carlos →
          </Link>
        </div>
