...
export const metadata: Metadata = buildMetadata({
  title: 'Relaxation Restorative Massage Therapy',
    ...
    <>
      ...
      <div className="bg-[#c6e28a] py-12 lg:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-[#618020] font-semibold uppercase tracking-widest text-sm mb-3">Relaxation Massage · Archway London</p>
          <h1 className="text-4xl lg:text-5xl font-bold text-[#334311] mb-4">
            Relaxation Restorative Massage Therapy
          </h1>
