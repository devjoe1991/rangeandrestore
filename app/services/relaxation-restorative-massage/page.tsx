...
const breadcrumbs = buildBreadcrumbs([
  ...
  { name: 'Relaxation Massage', path: '/services/relaxation-restorative-massage' },
])
    ...
    <>
      ...
      <div className="bg-page-sage section-md">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="eyebrow-sm">Relaxation Massage · Archway London</p>
      ...
      <div className="container-page container-wide">
        <div className="space-y-12">
          ...
          <section>
            ...
            <p className="text-page-muted mb-3">Your relaxation session will include:</p>
            <ul className="space-y-2">
              {[
          ...
          <section className="bg-accent rounded-2xl p-8 text-center sm:text-left">
            <h2 className="text-2xl font-black text-ink mb-4">Book your relaxation session</h2>
