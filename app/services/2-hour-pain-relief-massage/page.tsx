...
export const metadata: Metadata = buildMetadata({
  title: '2-Hour Pain Relief Massage – Extended Treatment',
    ...
    <>
      ...
      <div className="bg-[#c6e28a] py-12 lg:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-[#618020] font-semibold uppercase tracking-widest text-sm mb-3">Extended Treatment · Archway London</p>
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="space-y-12">
          <section>
            ...
            <p className="text-gray-700 mb-4">The 2-Hour Pain Relief Massage is designed for:</p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#334311] mb-4">Session length</h2>
            <div className="bg-[#c6e28a] rounded-xl p-6">
              <p className="font-bold text-[#334311] text-xl mb-2">2 Hours</p>
              <p className="text-[#334311]/80">Extended assessment-led treatment covering multiple problem areas and full-body recovery work. This session provides the time needed to properly address complex or long-standing conditions that cannot be fully resolved in a standard 60 or 90 minute appointment.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 mb-3">This extended session draws on a full range of advanced techniques including:</p>
            <ul className="space-y-2">
              {[
          ...
          <div className="border-t pt-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Link href="/services/massage-bundles" className="text-[#618020] hover:text-[#334311] font-medium min-h-[44px] flex items-center">
