    ...
    <>
      ...
      <div className="bg-[#eef2eb] py-12 lg:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-[#4a7a28] font-semibold uppercase tracking-widest text-sm mb-3">Extended Treatment · Archway London</p>
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="space-y-12">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#2c3d1f] mb-4">Session length</h2>
            <div className="bg-[#eef2eb] rounded-xl p-6">
              <p className="font-bold text-[#2c3d1f] text-xl mb-2">2 Hours</p>
              <p className="text-[#2c3d1f]/80">Extended assessment-led treatment covering multiple problem areas and full-body recovery work. This session provides the time needed to properly address complex or long-standing conditions that cannot be fully resolved in a standard 60 or 90 minute appointment.</p>
            </div>
          </section>
          ...
          <div className="border-t pt-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Link href="/services/massage-bundles" className="text-[#4a7a28] hover:text-[#2c3d1f] font-medium min-h-[44px] flex items-center">
