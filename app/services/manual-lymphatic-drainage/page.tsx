    ...
    <>
      ...
      <div className="bg-page-sage py-12 lg:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-[#0f767a] font-semibold uppercase tracking-widest text-sm mb-3">MLD · Archway London</p>
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="space-y-12">
          ...
          <section className="bg-[#7dd94a] rounded-2xl p-8 text-center sm:text-left">
            <h2 className="text-2xl font-black text-[#1a2330] mb-4">Book your MLD treatment</h2>
          ...
          <div className="border-t pt-8">
            <p className="text-page-muted text-sm mb-6 italic">
              ...
              {' '}<Link href="/recovery-suite/compression-therapy" className="text-[#0f767a] underline">Compression Therapy</Link>{' '}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Link href="/services/2-hour-pain-relief-massage" className="text-[#0f767a] hover:text-page font-medium min-h-[44px] flex items-center">
