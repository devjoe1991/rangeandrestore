    ...
    <>
      ...
      <div className="bg-[#c6e28a] py-12 lg:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-[#618020] font-semibold uppercase tracking-widest text-sm mb-3">Sports Massage · Archway London</p>
        ...
        <div className="space-y-12">
          ...
          <div className="border-t pt-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Link href="/blog/sports-massage-for-runners" className="text-[#618020] hover:text-[#334311] font-medium min-h-[44px] flex items-center">
