...
const treatments = [
  ...
  },
  {
    ...
    schemaName: 'Pregnancy Massage',
    href: '/services/pregnancy-massage',
    bookingHref: BOOKING_URLS.pregnancyMassage,
    badge: 'New',
    price: '£85',
    detail: '60 min',
    description: 'Safe, personalised treatment to relieve the muscular aches, joint discomfort and tension that commonly develop throughout pregnancy.',
  },
  {
    title: 'Reflexology',
    schemaName: 'Reflexology',
    href: '/services/reflexology',
    bookingHref: BOOKING_URLS.reflexology,
    badge: 'New',
    price: '£75',
    detail: '60 min',
    description: 'A gentle, relaxing foot-focused treatment to soothe tired feet, reduce stress and restore balance. Fully clothed — just shoes and socks off.',
  },
  {
