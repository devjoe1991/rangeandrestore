    ...
    <>
      ...
      <div className="container-page container-prose">
        <div className="prose prose-lg max-w-none text-page-muted space-y-6">
          ...
          <p>
            A great deal of everyday sciatic-type pain is linked to the way we sit. Hours at a desk leave the glutes weak and the hip and lower-back muscles tight, which is exactly the pattern that can irritate the sciatic nerve. This is why the same advice that helps <Link href={ROUTES.blog.deskPosturePainMassage} className="link-inline">desk posture and back pain</Link> often overlaps with managing sciatica, and why <Link href={ROUTES.blog.officeWorkerMassageArchway} className="link-inline">office workers in Archway</Link> are among the most common people we see with these symptoms.
          </p>
          ...
          <p>
            Sciatic pain often leads people to move stiffly and hold themselves awkwardly, which reinforces the tension. Assisted stretching, mobility work and an assessment-led approach help restore more natural movement through the hips and lower back and calm the protective guarding that keeps the cycle going. A <Link href={ROUTES.services.backNeckPainMot} className="link-inline">back and neck pain MOT</Link> is a useful way to map out exactly which areas are contributing.
          </p>
        ...
        <div className="mt-12 bg-accent rounded-2xl p-8 text-center sm:text-left">
          <h2 className="text-2xl font-black text-ink mb-4">Struggling with sciatica or a trapped nerve?</h2>
