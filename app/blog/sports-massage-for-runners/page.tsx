    ...
    <>
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
        <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
          ...
          <h2 className="text-2xl font-bold text-[#334311] mt-8 mb-3">Before the race: preparation massage</h2>
          ...
          <h2 className="text-2xl font-bold text-[#334311] mt-8 mb-3">After the race: recovery massage</h2>
          ...
          <h2 className="text-2xl font-bold text-[#334311] mt-8 mb-3">During training: maintenance massage</h2>
          ...
          <h2 className="text-2xl font-bold text-[#334311] mt-8 mb-3">What to expect from a session at Range and Restore</h2>
