      ...
      <div className="bg-page-sage py-12 lg:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 flex flex-wrap gap-4 text-sm">
            ...
            <span className="inline-flex items-center gap-1.5 bg-badge-teal text-page font-semibold px-3 py-1.5 rounded-full border border-[#2ab4b8]/30">Sports Massage &amp; Soft Tissue Therapy</span>
      ...
      <section id="carlos-bonvicine" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-12 lg:pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <p className="text-[#2ab4b8] font-semibold mb-1">Founder &amp; Lead Therapist</p>
