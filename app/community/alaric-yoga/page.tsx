  ...
  return (
    <>
      ...
      <div className="container-page container-prose">
        ...
        <figure className="rounded-card overflow-hidden border-2 border-brand-green bg-page-sage mb-10">
          <Image
            src="/alaric_yoga.jpg"
            ...
            priority
          />
          <figcaption className="px-4 py-3 text-sm text-page-muted">
            Alaric Newcombe, Senior Level 3 Iyengar Yoga teacher at Alaric Yoga.
          </figcaption>
        </figure>
        ...
        <div className="prose prose-lg max-w-none text-page-muted space-y-6">
          ...
          <p>
            Range and Restore Sports Massage in Archway has been working closely with Alaric Newcombe of Alaric Yoga, supporting both Alaric&apos;s own recovery and many of his yoga students through sports and soft tissue remedial therapy at the clinic at 130 Junction Road, London N19.
          </p>
          <p>
          ...
          <p>
            We&apos;re grateful for the ongoing support, kind feedback and recommendations from both Alaric and his students. What makes this collaboration worthwhile is the community behind it: a shared focus on helping people feel better, move better and stay consistent with their health and wellbeing long term.
          </p>
          <p>
          ...
          <p>
            One thing that stands out to us is how highly Alaric&apos;s students speak about him. Not only his knowledge and teaching style, but also his patience, dedication and care for the people he teaches. There is clearly a huge amount of respect and admiration for him within his community, and that comes through every time one of his students walks into the clinic.
          </p>
        ...
        <div className="mt-12 bg-accent rounded-2xl p-8 text-center sm:text-left">
          ...
          <p className="text-brand-green font-semibold mb-6">
            Yoga student, Iyengar practitioner or anyone with a regular movement practice? Range and Restore at 130 Junction Road, Archway N19 offers assessment-led sports massage, deep tissue, advanced clinical massage and MLD. Same-week appointments, a short walk from Archway tube. Visit Alaric Newcombe&apos;s Iyengar yoga and pranayama site for class details.
          </p>
