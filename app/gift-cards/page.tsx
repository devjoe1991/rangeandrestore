...
const giftCardSchema = {
  ...
  description: 'Gift card for any amount, sent by email with a unique code. Redeemable against any treatment at Range and Restore in Archway, North London, including Recovery Suite sauna sessions (not bundle packages). Valid for 12 months.',
      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-12 lg:py-20 text-center">
        ...
        <div className="bg-page-alt rounded-xl p-6 text-left border border-page">
          ...
          <ul className="space-y-2 text-page-muted">
            ...
            <li className="flex items-start gap-2">
              <span className="text-brand-teal font-bold mt-0.5">•</span>
              Redeemable against any treatment at Range and Restore Sports Massage, including the sauna.
            </li>
            <li className="flex items-start gap-2">
              <span className="text-brand-teal font-bold mt-0.5">•</span>
